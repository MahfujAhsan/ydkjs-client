...
const Reviews = (props) => {
    ...
    return (
        <div >
            <div className='text-center border border-black p-4 rounded-lg h-[480px] relative'>
                ...
                <p className='mt-5 w-full absolute bottom-5 font-mono text-xl font-bold'>Ratings: <span className='text-4xl text-yellow-600'>{ratings}</span> stars</p>
            </div>
        </div>
    );
};
